 ...
 * @param size size of space pointed to by ptr
 */
void dlist_add_frontv(struct dlist *l, void *ptr, size_t size);
 ...
 * @param size size of space pointed to by ptr
 */
void dlist_add_backv(struct dlist *l, void *ptr, size_t size);
 ...
 * @param ptr pointer to generic data to store in new list node
 */
void dlist_add_back(struct dlist *l, char *ptr);
 ...
 * 
 * @param l pointer to the list (non-NULL)
 * @return node containing data and size of data found
 */
struct dnode dlist_remove_frontv(struct dlist *l);
 ...
 * @return node containing data and size of data found
 */
struct dnode dlist_remove_backv(struct dlist *l);
 ...
 * @return node containing data and size of data found
 */
struct dnode dlist_find_removev(struct dlist *l, void *ptr);
